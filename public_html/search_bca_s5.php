...
$q_books = "SELECT DISTINCT book_name FROM bca WHERE book_name LIKE '%$searchQuery%' and semester = '$semester'";
$p_books = mysqli_query($c, $q_books);

// Fetch author names based on the search query
$q_authors = "SELECT DISTINCT author FROM bca WHERE author LIKE '%$searchQuery%' and semester = '$semester'";
